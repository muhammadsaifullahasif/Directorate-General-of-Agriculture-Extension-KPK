...
<head>
	...
	$page_title = 'Stock Fumigation History';
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							...
							if(isset($_GET['query'])) {
								echo "<a href='stock-fumigation-history.php' class='btn btn-link btn-sm mb-3 ml-2'><i class='fas fa-times mr-2'></i>Remove Filter</a>";
							}
										...
										<table class="table table-striped table-hover table-sm" id="table">
											...
											<tbody id="display_stocks">
												...
												if(isset($_GET['query']) && $_GET['query'] == 'filter') {
													...
													$sql_query = "SELECT sf.id, sf.stock_id, sf.circle_id, s.crop, s.lot_number, s.variety, s.class, sf.parent_id, sf.processing_qty, sf.time_created FROM stocks AS s INNER JOIN stock_fumigation AS sf ON s.id=sf.parent_id WHERE s.delete_status='0'";
													...
													$sql_query .= " ORDER BY sf.time_created DESC";
													$query = mysqli_query($conn, $sql_query);

												} else {

													$query = mysqli_query($conn, "SELECT sf.id, sf.stock_id, sf.circle_id, s.crop, s.lot_number, s.variety, s.class, sf.parent_id, sf.processing_qty, sf.time_created FROM stocks AS s INNER JOIN stock_fumigation AS sf ON s.id=sf.parent_id WHERE s.delete_status='0'");
